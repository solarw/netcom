...
- **Key components**: 
  ...
  - xnetwork2 (новая версия xnetwork) - основное место разработки
  - rust-libp2p папка с полным кодом проекта libp2p для чтения информации о библиобеке и компонентах
